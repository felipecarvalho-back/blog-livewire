...
<div class="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-4 sm:p-6 lg:p-8 antialiased">
    ...
    <div class="w-full max-w-[480px]">
        ...
        <div class="text-center mb-8">
            <div
                class="inline-flex bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 rounded-2xl p-2 w-12 h-12 items-center justify-center shadow-md mb-4">
        ...
        <flux:card
            class="p-8 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 backdrop-blur-xl shadow-xl rounded-2xl">
            <form wire:submit="register" class="space-y-5">
                <!-- Name Field -->
                <flux:field>
                    <flux:label>Nome Completo</flux:label>
                    <flux:input type="text" wire:model="name" placeholder="Seu Nome" icon="user" />
                ...
                <flux:field>
                    ...
                    <flux:input type="email" wire:model="email" placeholder="seu-email@exemplo.com" icon="envelope" />
                ...
                <flux:field>
                    ...
                    <flux:input type="password" wire:model="password" placeholder="••••••••" viewable icon="key" />
                ...
                <flux:field>
                    ...
                    <flux:input type="password" wire:model="password_confirmation" placeholder="••••••••" viewable
                        icon="key" />
                ...
                <flux:field variant="inline" class="items-start">
                    <div class="flex align-center gap-2 justify-center">
                        ...
                        <label
                            class="text-xs text-zinc-650 dark:text-zinc-400 leading-normal select-none cursor-pointer">
                            Eu concordo com os
                            <a href="#"
                                class="font-semibold text-violet-600 dark:text-violet-400 hover:underline">Termos de
                                Serviço</a>
                            e a
                            <a href="#"
                                class="font-semibold text-violet-600 dark:text-violet-400 hover:underline">Política de
                                Privacidade</a>.
                        </label>
                    </div>
        ...
        <p class="mt-8 text-center text-sm text-zinc-500 dark:text-zinc-400">
            Já possui uma conta?
            <a href="{{ route('login') }}" class="font-semibold text-violet-600 dark:text-violet-400 hover:underline"
                wire:navigate>
                Fazer Login
            </a>
        </p>
