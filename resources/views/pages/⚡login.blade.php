...
new #[Title('Entrar')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        if (Auth::attempt($credentials, $this->remember)) {
            ...
            session()->flash('error', 'E-mail ou senha incorretos. Por favor, verifique suas credenciais.');
...
<div class="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-4 sm:p-6 lg:p-8 antialiased">
    ...
    <div class="w-full max-w-[480px]">
            ...
            <div class="grid grid-cols-2 gap-4">
                <flux:button variant="outline" class="w-full">
                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                        <path
                            d="M12.24 10.285V13.4h6.887C18.2 15.614 15.645 18 12.24 18c-3.86 0-7-3.14-7-7s3.14-7 7-7c1.7 0 3.3.6 4.5 1.7l2.42-2.42C17.34 1.765 14.94 1 12.24 1c-5.52 0-10 4.48-10 10s4.48 10 10 10c5.73 0 10.2-4.004 10.2-9.715 0-.608-.06-1.216-.162-1.8H12.24z" />
                    </svg>
                    Google
                </flux:button>
                <flux:button variant="outline" class="w-full">
        ...
        <p class="mt-8 text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <a href="{{ route('register') }}" class="font-semibold text-violet-600 dark:text-violet-400 hover:underline"
                wire:navigate>
                Cadastre-se grátis
            </a>
        </p>
